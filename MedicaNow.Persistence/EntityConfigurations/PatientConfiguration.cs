...
namespace MedicaNow.Persistence.EntityConfigurations
{
    public class PatientConfiguration : IEntityTypeConfiguration<Patient>
    {
        public void Configure(EntityTypeBuilder<Patient> builder)
        {
            ...
            builder.HasMany(u => u.Appointments).WithOne(y => y.Patient).HasForeignKey(y => y.DoctorId);
            builder.HasMany(u => u.Ratings).WithOne(y => y.Patient).HasForeignKey(y => y.DoctorId);
        }
    }
}
